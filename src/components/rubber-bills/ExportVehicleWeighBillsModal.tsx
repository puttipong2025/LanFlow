  ...
  return (
    <section className="space-y-4" aria-label="บิลรถส่งออก">
      <div className="flex flex-col items-start gap-3 rounded-md border border-black/10 bg-white p-4 shadow-panel">
        <div><h2 className="text-balance text-lg font-bold text-ink">บิลรถส่งออก (WEX) · {selectedLocation.name}</h2><p className="text-pretty text-sm text-ink/60">หลักฐานชั่งและบรรทุกยางของรถบรรทุก พร้อมรถพ่วงเสริมได้หนึ่งรายการ โดยไม่สร้างรายการการเงินหรือรายงาน</p></div>
