  ...
  return (
    ...
    >
      <div className="space-y-5">
        {!online && <p role="status" className="rounded-md bg-amber/20 px-4 py-3 text-sm font-semibold text-amber-900">กำลังแสดงข้อมูลล่าสุดที่โหลดไว้; WEX แชร์ได้เมื่อออนไลน์เท่านั้น</p>}
