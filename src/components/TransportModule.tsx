        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-6">
                    ...
                    <tr key={b.id || idx} className={`border-b last:border-b-0 transition-colors ${b.isPrimary ? 'bg-amber-50/60' : ''}`}>
                      <td className="py-1.5 text-center">
                        ...
                        >
                          ...
                          {b.isPrimary ? "บัญชีหลัก" : "ตั้งเป็นหลัก"}
                        </button>
                      </td>
          ...
          <div className="flex items-center justify-end gap-3 border-t border-black/10 pt-4">
            ...
            <button
              type="submit"
              disabled={!online}
              className="flex h-10 items-center gap-1.5 rounded-lg bg-commit px-5 text-sm font-semibold text-white shadow transition-colors hover:bg-commit/90 disabled:cursor-not-allowed disabled:bg-slate-300"
            >
              <ShieldCheck size={18} />
