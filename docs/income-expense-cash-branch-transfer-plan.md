...
> [!IMPORTANT]
> เอกสารส่วน checklist ด้านล่างเป็นประวัติการสร้างฟีเจอร์ครั้งแรกเมื่อ 2026-07-23
> กติกา `mismatched` / `difference_accepted`, action “ยอมรับผลต่าง” และสิทธิ์ลบแบบ
> `super_admin` เท่านั้น ถูกแทนที่เมื่อ 2026-07-27 โดย
> `docs/adr/0015-close-cash-transfer-on-receipt-and-gate-deletion.md`.
> Contract ปัจจุบันคือปลายทางยืนยันรับแล้วจบที่ `received` เสมอ, เก็บผลต่างเป็นหลักฐาน,
> และการลบหลังรับเงินใช้ค่ากลางอนุมัติในโมดูลตั้งค่าและอนุมัติรับ-จ่าย.
