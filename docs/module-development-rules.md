...
- การรวมรายการรอโอนต้องทำผ่าน atomic RPC เท่านั้น: จำกัดสาขาปัจจุบัน, `customer_id + account_number` เดียวกัน, ไม่มีสลิป, ไม่ถูก Report Lock, เก็บ parent เก่าสุด, ย้าย item แล้ว soft-delete parent อื่น ห้ามปลด Report Lock หรือสร้าง parent ใหม่เพื่อหลบกฎ
