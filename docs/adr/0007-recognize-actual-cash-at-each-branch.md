...
Superseded by ADR-0015. The sent/received accounting amounts and dates remain valid; only the mismatched pending state and separate settlement action were replaced.
