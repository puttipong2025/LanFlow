-- Preserve optimistic revision checks while allowing an existing locked source
-- to remain attached to the same transfer. Changed/new locked sources stay blocked.
