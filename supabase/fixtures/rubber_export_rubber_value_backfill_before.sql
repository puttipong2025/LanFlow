-- Self-contained fixture applied after 20260819150000 and before 20260820010000.
-- The deduction-bearing ordinary bill is inserted before its report lock.
...
insert into public.rubber_bills (
  ...
  100, 0, 4000, 40, 400, 3600, '2026-08-08 00:00:00+00',
...
insert into public.rubber_bill_items (
  ...
  'b3000000-0000-4000-8000-000000000001', 'weigh', 100, 100, 'kg', 40, 4000
);
