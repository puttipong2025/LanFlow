...
CREATE OR REPLACE FUNCTION "private"."delete_money_transfer"("p_transfer_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "private"."guard_branch_receipt_bill"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
begin
...
ALTER FUNCTION "private"."guard_branch_receipt_bill"() OWNER TO "postgres";
...
ALTER FUNCTION "private"."guard_received_rubber_export_delete"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "private"."merge_pending_money_transfers"("p_location_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "private"."money_transfer_source_relations"("p_location_id" "uuid", "p_source_type" "text" DEFAULT NULL::"text") RETURNS TABLE("source_type" "text", "source_id" "uuid", "transfer_id" "uuid")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "private"."money_transfer_source_relations"("p_location_id" "uuid", "p_source_type" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "private"."next_document_sequence"("p_document_kind" "text", "p_location_id" "uuid", "p_document_date" "date") RETURNS integer
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "private"."next_document_sequence"("p_document_kind" "text", "p_location_id" "uuid", "p_document_date" "date") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "private"."require_rubber_bill_evidence_review_manager"("p_location_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
begin
...
ALTER FUNCTION "private"."rubber_bill_current_work_items"("p_location_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "private"."rubber_bill_evidence_pending_snapshot"("p_location_id" "uuid") RETURNS TABLE("item_count" bigint, "item_fingerprint" "text")
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  select
...
ALTER FUNCTION "private"."rubber_bill_evidence_review_states"("p_location_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "private"."rubber_bill_evidence_review_states_for_bills"("p_location_id" "uuid", "p_bill_ids" "uuid"[]) RETURNS TABLE("location_id" "uuid", "bill_id" "uuid", "revision_no" integer, "client_created_at" timestamp with time zone, "review_period_id" "uuid", "review_status" "text", "missing_rubber" boolean, "missing_display_in" boolean, "has_manual_correction" boolean, "is_unpriced" boolean, "has_any_evidence" boolean, "required_role_count" bigint, "present_required_role_count" bigint, "decision" "text", "reviewed_by_name" "text", "reviewed_at" timestamp with time zone)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  with bill_rows as (
...
CREATE OR REPLACE FUNCTION "private"."rubber_bill_is_branch_receipt_reportable"("p_bill_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  select exists (
...
ALTER FUNCTION "private"."rubber_export_age_hours"("p_bill_date" "date", "p_age_source_at" timestamp with time zone, "p_cutoff_at" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "private"."rubber_export_age_summary"("p_export_id" "uuid", "p_cutoff_at" timestamp with time zone) RETURNS TABLE("average_age_hours" numeric, "oldest_age_hours" numeric, "estimated_age_item_count" integer)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  select
...
ALTER FUNCTION "private"."rubber_export_candidates"("p_location_id" "uuid", "p_selected_report_item_ids" "uuid"[], "p_current_export_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "private"."rubber_export_effective_age_start"("p_bill_date" "date", "p_age_source_at" timestamp with time zone, "p_cutoff_at" timestamp with time zone) RETURNS timestamp with time zone
    LANGUAGE "sql" IMMUTABLE
    SET "search_path" TO ''
    AS $$
  select case
...
ALTER FUNCTION "private"."rubber_export_effective_age_start"("p_bill_date" "date", "p_age_source_at" timestamp with time zone, "p_cutoff_at" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "private"."rubber_export_item_age_hours"("p_bill_date" "date", "p_age_source_at" timestamp with time zone, "p_carried_age_hours" numeric, "p_cutoff_at" timestamp with time zone) RETURNS numeric
    LANGUAGE "sql" IMMUTABLE
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "private"."rubber_export_item_age_hours"("p_bill_date" "date", "p_age_source_at" timestamp with time zone, "p_carried_age_hours" numeric, "p_cutoff_at" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "private"."rubber_export_raw_age_summary"("p_export_id" "uuid", "p_cutoff_at" timestamp with time zone) RETURNS TABLE("average_age_hours" numeric, "oldest_age_hours" numeric, "estimated_age_item_count" integer)
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  select
...
ALTER FUNCTION "private"."rubber_export_raw_age_summary"("p_export_id" "uuid", "p_cutoff_at" timestamp with time zone) OWNER TO "postgres";


COMMENT ON FUNCTION "private"."rubber_export_raw_age_summary"("p_export_id" "uuid", "p_cutoff_at" timestamp with time zone) IS 'Unrounded weighted age used before receipt/downstream snapshot rounding.';
...
CREATE OR REPLACE FUNCTION "private"."validate_rubber_export_selection"("p_location_id" "uuid", "p_selected_report_item_ids" "uuid"[], "p_current_export_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "public"."close_rubber_bill_evidence_review_period"("p_location_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "public"."decide_rubber_bill_evidence_review"("p_location_id" "uuid", "p_bill_id" "uuid", "p_revision_no" integer, "p_expected_status" "text", "p_decision" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."decide_rubber_bill_evidence_review"("p_location_id" "uuid", "p_bill_id" "uuid", "p_revision_no" integer, "p_expected_status" "text", "p_decision" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_money_transfer_detail"("p_transfer_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_money_transfer_list"("p_location_id" "uuid", "p_status" "text" DEFAULT 'all'::"text", "p_search" "text" DEFAULT ''::"text", "p_cursor_created_at" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_cursor_id" "uuid" DEFAULT NULL::"uuid", "p_page_size" integer DEFAULT 50) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."get_money_transfer_list"("p_location_id" "uuid", "p_status" "text", "p_search" "text", "p_cursor_created_at" timestamp with time zone, "p_cursor_id" "uuid", "p_page_size" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_money_transfer_source_locks"("p_location_id" "uuid", "p_source_type" "text", "p_source_ids" "uuid"[] DEFAULT NULL::"uuid"[]) RETURNS TABLE("source_type" "text", "source_id" "uuid", "transfer_id" "uuid")
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
begin
...
ALTER FUNCTION "public"."get_money_transfer_source_locks"("p_location_id" "uuid", "p_source_type" "text", "p_source_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_money_transfer_sources"("p_location_id" "uuid", "p_source_type" "text", "p_search" "text" DEFAULT ''::"text", "p_cursor_created_at" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_cursor_id" "uuid" DEFAULT NULL::"uuid", "p_page_size" integer DEFAULT 50, "p_selected_ids" "uuid"[] DEFAULT ARRAY[]::"uuid"[]) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "public"."get_rubber_bill_evidence_review_states"("p_location_id" "uuid") RETURNS TABLE("location_id" "uuid", "bill_id" "uuid", "revision_no" integer, "client_created_at" timestamp with time zone, "review_period_id" "uuid", "review_status" "text", "missing_rubber" boolean, "missing_display_in" boolean, "has_manual_correction" boolean, "is_unpriced" boolean, "has_any_evidence" boolean, "required_role_count" bigint, "present_required_role_count" bigint, "decision" "text", "reviewed_by_name" "text", "reviewed_at" timestamp with time zone)
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
begin
...
CREATE OR REPLACE FUNCTION "public"."get_rubber_bill_evidence_states_for_bills"("p_location_id" "uuid", "p_bill_ids" "uuid"[]) RETURNS TABLE("location_id" "uuid", "bill_id" "uuid", "revision_no" integer, "client_created_at" timestamp with time zone, "review_period_id" "uuid", "review_status" "text", "missing_rubber" boolean, "missing_display_in" boolean, "has_manual_correction" boolean, "is_unpriced" boolean, "has_any_evidence" boolean, "required_role_count" bigint, "present_required_role_count" bigint, "decision" "text", "reviewed_by_name" "text", "reviewed_at" timestamp with time zone)
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
begin
...
ALTER FUNCTION "public"."get_rubber_bill_work_counts"("p_location_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_rubber_export_age_detail"("p_export_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."get_rubber_export_age_detail"("p_export_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_rubber_export_age_summaries"("p_location_id" "uuid") RETURNS TABLE("export_id" "uuid", "calculated_at" timestamp with time zone, "average_age_hours" numeric, "oldest_age_hours" numeric, "estimated_age_item_count" integer, "receipt_bill_id" "uuid", "receipt_bill_no" "text", "receipt_location_name" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."get_telegram_evidence_location_config"() RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."merge_pending_money_transfers"("p_location_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."open_rubber_bill_evidence_review_period"("p_location_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."open_rubber_bill_evidence_review_period"("p_location_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."pass_all_pending_rubber_bill_evidence_reviews"("p_location_id" "uuid", "p_expected_pending_count" bigint, "p_expected_pending_fingerprint" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."pass_all_pending_rubber_bill_evidence_reviews"("p_location_id" "uuid", "p_expected_pending_count" bigint, "p_expected_pending_fingerprint" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."preview_rubber_export"("p_location_id" "uuid", "p_selected_report_item_ids" "uuid"[], "p_current_export_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "public"."receive_rubber_export"("p_destination_location_id" "uuid", "p_source_rubber_export_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
CREATE TABLE IF NOT EXISTS "public"."rubber_exports" (
    ...
    "deleted_by_phone" "text",
    "deleted_at" timestamp with time zone,
    "age_cutoff_at" timestamp with time zone,
    "average_age_hours" numeric(14,2),
    "oldest_age_hours" numeric(14,2),
    "estimated_age_item_count" integer,
...
CREATE OR REPLACE FUNCTION "public"."save_telegram_badge_config_with_evidence_locations"("payload" "jsonb", "p_all_locations" boolean, "p_location_ids" "uuid"[]) RETURNS "jsonb"
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."save_telegram_badge_config_with_evidence_locations"("payload" "jsonb", "p_all_locations" boolean, "p_location_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."save_telegram_evidence_location_config"("p_all_locations" boolean, "p_location_ids" "uuid"[]) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."save_telegram_evidence_location_config"("p_all_locations" boolean, "p_location_ids" "uuid"[]) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "private"."money_transfer_delete_context" (
...
CREATE TABLE IF NOT EXISTS "public"."document_deletion_audits" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "document_kind" "text" NOT NULL,
    "source_id" "uuid" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."rubber_bill_evidence_review_periods" (
    ...
    "closed_by_name" "text",
    CONSTRAINT "rubber_bill_evidence_review_periods_close_actor" CHECK (((("closed_at" IS NULL) AND ("closed_by_user_id" IS NULL) AND ("closed_by_name" IS NULL)) OR (("closed_at" IS NOT NULL) AND ("closed_by_user_id" IS NOT NULL) AND ("closed_by_name" IS NOT NULL)))),
    CONSTRAINT "rubber_bill_evidence_review_periods_close_order" CHECK ((("closed_at" IS NULL) OR ("closed_at" >= "opened_at")))
);


ALTER TABLE "public"."rubber_bill_evidence_review_periods" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rubber_bill_evidence_reviews" (
    "bill_id" "uuid" NOT NULL,
    "revision_no" integer NOT NULL,
    ...
    CONSTRAINT "rubber_bill_evidence_reviews_decision_check" CHECK (("decision" = ANY (ARRAY['pass'::"text", 'improve'::"text"]))),
    CONSTRAINT "rubber_bill_evidence_reviews_revision_no_check" CHECK (("revision_no" >= 0))
);


ALTER TABLE "public"."rubber_bill_evidence_reviews" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."telegram_badge_settings" (
    ...
    "evidence_all_locations" boolean DEFAULT true NOT NULL,
    "evidence_location_ids" "uuid"[] DEFAULT ARRAY[]::"uuid"[] NOT NULL,
...
ALTER TABLE ONLY "private"."document_number_counters"
    ADD CONSTRAINT "document_number_counters_pkey" PRIMARY KEY ("document_kind", "location_id", "document_date");



ALTER TABLE ONLY "private"."money_transfer_delete_context"
    ADD CONSTRAINT "money_transfer_delete_context_pkey" PRIMARY KEY ("backend_pid", "transaction_id", "transfer_id");
...
ALTER TABLE ONLY "public"."document_deletion_audits"
    ADD CONSTRAINT "document_deletion_audits_document_kind_source_id_key" UNIQUE ("document_kind", "source_id");



ALTER TABLE ONLY "public"."document_deletion_audits"
    ADD CONSTRAINT "document_deletion_audits_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."rubber_bill_evidence_review_periods"
    ADD CONSTRAINT "rubber_bill_evidence_review_periods_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rubber_bill_evidence_reviews"
    ADD CONSTRAINT "rubber_bill_evidence_reviews_pkey" PRIMARY KEY ("bill_id");
...
CREATE INDEX "document_deletion_audits_location_kind_time" ON "public"."document_deletion_audits" USING "btree" ("location_id", "document_kind", "deleted_at" DESC, "id" DESC);
...
CREATE INDEX "money_transfer_items_transfer_idx" ON "public"."money_transfer_items" USING "btree" ("transfer_id", "created_at", "id");
...
CREATE INDEX "rubber_bill_approval_current_work_idx" ON "public"."rubber_bill_approval_requests" USING "btree" ("location_id", "requested_at", "id") WHERE ("request_status" = 'pending'::"text");
...
CREATE INDEX "rubber_bill_evidence_review_periods_scope_lookup" ON "public"."rubber_bill_evidence_review_periods" USING "btree" ("location_id", "opened_at", "closed_at");
...
CREATE INDEX "rubber_bills_branch_receipt_source_lookup" ON "public"."rubber_bills" USING "btree" ("source_rubber_export_id", "record_status");
...
CREATE UNIQUE INDEX "rubber_bills_one_active_branch_receipt" ON "public"."rubber_bills" USING "btree" ("source_rubber_export_id") WHERE (("source_rubber_export_id" IS NOT NULL) AND ("record_status" = 'active'::"public"."record_status"));



CREATE INDEX "rubber_bills_operational_cursor_idx" ON "public"."rubber_bills" USING "btree" ("location_id", COALESCE("client_created_at", "created_at") DESC, "id" DESC) WHERE ("record_status" = 'active'::"public"."record_status");
...
CREATE OR REPLACE TRIGGER "guard_received_rubber_export_delete" BEFORE UPDATE OF "status" ON "public"."rubber_exports" FOR EACH ROW EXECUTE FUNCTION "private"."guard_received_rubber_export_delete"();
...
ALTER TABLE ONLY "public"."rubber_bill_evidence_review_periods"
    ADD CONSTRAINT "rubber_bill_evidence_review_periods_closed_by_user_id_fkey" FOREIGN KEY ("closed_by_user_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."rubber_bill_evidence_review_periods"
    ADD CONSTRAINT "rubber_bill_evidence_review_periods_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id");



ALTER TABLE ONLY "public"."rubber_bill_evidence_review_periods"
    ADD CONSTRAINT "rubber_bill_evidence_review_periods_opened_by_user_id_fkey" FOREIGN KEY ("opened_by_user_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."rubber_bill_evidence_reviews"
    ADD CONSTRAINT "rubber_bill_evidence_reviews_bill_id_fkey" FOREIGN KEY ("bill_id") REFERENCES "public"."rubber_bills"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rubber_bill_evidence_reviews"
    ADD CONSTRAINT "rubber_bill_evidence_reviews_reviewed_by_user_id_fkey" FOREIGN KEY ("reviewed_by_user_id") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."rubber_bills"
    ADD CONSTRAINT "rubber_bills_source_rubber_export_id_fkey" FOREIGN KEY ("source_rubber_export_id") REFERENCES "public"."rubber_exports"("id");
...
ALTER TABLE ONLY "public"."rubber_exports"
    ADD CONSTRAINT "rubber_exports_sold_out_by_user_id_fkey" FOREIGN KEY ("sold_out_by_user_id") REFERENCES "public"."profiles"("id");
...
CREATE POLICY "rubber_bill_evidence_review_periods_branch_read" ON "public"."rubber_bill_evidence_review_periods" FOR SELECT TO "authenticated" USING ("private"."can_access_location"("location_id"));
...
CREATE POLICY "rubber_bill_evidence_reviews_branch_read" ON "public"."rubber_bill_evidence_reviews" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."rubber_bills" "b"
  WHERE (("b"."id" = "rubber_bill_evidence_reviews"."bill_id") AND "private"."can_access_location"("b"."location_id")))));
...
REVOKE ALL ON FUNCTION "private"."money_transfer_source_relations"("p_location_id" "uuid", "p_source_type" "text") FROM PUBLIC;



REVOKE ALL ON FUNCTION "private"."next_document_sequence"("p_document_kind" "text", "p_location_id" "uuid", "p_document_date" "date") FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "private"."rubber_bill_evidence_review_states"("p_location_id" "uuid") FROM PUBLIC;



REVOKE ALL ON FUNCTION "private"."rubber_bill_evidence_review_states_for_bills"("p_location_id" "uuid", "p_bill_ids" "uuid"[]) FROM PUBLIC;
...
REVOKE ALL ON FUNCTION "public"."close_rubber_bill_evidence_review_period"("p_location_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."close_rubber_bill_evidence_review_period"("p_location_id" "uuid") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."decide_rubber_bill_evidence_review"("p_location_id" "uuid", "p_bill_id" "uuid", "p_revision_no" integer, "p_expected_status" "text", "p_decision" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."decide_rubber_bill_evidence_review"("p_location_id" "uuid", "p_bill_id" "uuid", "p_revision_no" integer, "p_expected_status" "text", "p_decision" "text") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."get_money_transfer_detail"("p_transfer_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_money_transfer_detail"("p_transfer_id" "uuid") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."get_money_transfer_list"("p_location_id" "uuid", "p_status" "text", "p_search" "text", "p_cursor_created_at" timestamp with time zone, "p_cursor_id" "uuid", "p_page_size" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_money_transfer_list"("p_location_id" "uuid", "p_status" "text", "p_search" "text", "p_cursor_created_at" timestamp with time zone, "p_cursor_id" "uuid", "p_page_size" integer) TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."get_money_transfer_source_locks"("p_location_id" "uuid", "p_source_type" "text", "p_source_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_money_transfer_source_locks"("p_location_id" "uuid", "p_source_type" "text", "p_source_ids" "uuid"[]) TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."get_receivable_rubber_exports"("p_destination_location_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_receivable_rubber_exports"("p_destination_location_id" "uuid") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."get_rubber_bill_evidence_review_overview"("p_location_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_rubber_bill_evidence_review_overview"("p_location_id" "uuid") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."get_rubber_bill_evidence_review_states"("p_location_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_rubber_bill_evidence_review_states"("p_location_id" "uuid") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."get_rubber_bill_evidence_states_for_bills"("p_location_id" "uuid", "p_bill_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_rubber_bill_evidence_states_for_bills"("p_location_id" "uuid", "p_bill_ids" "uuid"[]) TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."get_rubber_export_age_detail"("p_export_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_rubber_export_age_detail"("p_export_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_rubber_export_age_detail"("p_export_id" "uuid") TO "service_role";



REVOKE ALL ON FUNCTION "public"."get_rubber_export_age_summaries"("p_location_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_rubber_export_age_summaries"("p_location_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_rubber_export_age_summaries"("p_location_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."get_telegram_evidence_location_config"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_telegram_evidence_location_config"() TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."get_weight_evidence_review_digest"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_weight_evidence_review_digest"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."merge_pending_money_transfers"("p_location_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."merge_pending_money_transfers"("p_location_id" "uuid") TO "authenticated";



REVOKE ALL ON FUNCTION "public"."open_rubber_bill_evidence_review_period"("p_location_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."open_rubber_bill_evidence_review_period"("p_location_id" "uuid") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."preview_rubber_export"("p_location_id" "uuid", "p_selected_report_item_ids" "uuid"[], "p_current_export_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."preview_rubber_export"("p_location_id" "uuid", "p_selected_report_item_ids" "uuid"[], "p_current_export_id" "uuid") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."replace_rubber_export_items"("p_export_id" "uuid", "p_selected_report_item_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."replace_rubber_export_items"("p_export_id" "uuid", "p_selected_report_item_ids" "uuid"[]) TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."save_telegram_badge_config_with_evidence_locations"("payload" "jsonb", "p_all_locations" boolean, "p_location_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."save_telegram_badge_config_with_evidence_locations"("payload" "jsonb", "p_all_locations" boolean, "p_location_ids" "uuid"[]) TO "authenticated";



REVOKE ALL ON FUNCTION "public"."save_telegram_evidence_location_config"("p_all_locations" boolean, "p_location_ids" "uuid"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."save_telegram_evidence_location_config"("p_all_locations" boolean, "p_location_ids" "uuid"[]) TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."set_rubber_export_sold_out"("p_export_id" "uuid", "p_sold_out" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."set_rubber_export_sold_out"("p_export_id" "uuid", "p_sold_out" boolean) TO "authenticated";
...
GRANT ALL ON TABLE "public"."rubber_bill_evidence_reviews" TO "service_role";
GRANT SELECT ON TABLE "public"."rubber_bill_evidence_reviews" TO "authenticated";
